package pl.suspendmode.freestuff.repository;

import pl.suspendmode.freestuff.FreestuffApp;
import pl.suspendmode.freestuff.config.Constants;
import pl.suspendmode.freestuff.config.audit.AuditEventConverter;
import pl.suspendmode.freestuff.domain.PersistentAuditEvent;
...
import static pl.suspendmode.freestuff.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
